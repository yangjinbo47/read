<template>
  <div class="dialog">
    ...
    <div class="dialog-content">
      ...
      <div class="btn-group">
        <div class="btn" @click="cancel" v-show="modal.isShowCancelButton">{{ modal.cancelButtonText }}</div>
        <div class="btn" @click="closeMyself">{{ modal.confirmButtonText }}</div>
      </div>
    </div>
  </div>
</template>
    ...
    computed: {
      modal: function() {
        ...
        return {
          ...
          text: options.text,
          isShowCancelButton : options.isShowCancelButton ? options.isShowCancelButton : false,
